# Arcology Documentation Index

> Searchable index of all concepts, systems, and files. Use Ctrl+F / Cmd+F.
...
- **Agent** - Simulated resident, see [human-simulation/agents.md](./game-design/human-simulation/agents.md)
- **Air Quality** - Environment system, see [environment/air-system.md](./game-design/environment/air-system.md)
- **Airspace Permit** - Building height permission, see [economy/permits.md](./game-design/economy/permits.md)
- **Archetype** - Resident category, see [human-simulation/agents.md](./game-design/human-simulation/agents.md#archetypes)
...
- **Cohesion** - Community metric, see [human-simulation/relationships.md](./game-design/human-simulation/relationships.md#community-cohesion)
- **Commercial Blocks** - Retail, food, office, see [blocks/commercial.md](./game-design/blocks/commercial.md)
- **Complaint** - Resident feedback, see [ui/narrative.md](./ui/narrative.md#complaints)
- **Connectivity** - Path to entrance, see [architecture/milestones/milestone-3-connectivity.md](./architecture/milestones/milestone-3-connectivity.md)
...
- **Desirability** - Rent calculation factor, see [formulas.md](./quick-reference/formulas.md#residential-rent)
- **Destination Dispatch** - Elevator algorithm, see [transit/elevators.md](./game-design/transit/elevators.md)

### E
- **Economy** - Budget system, see [economy/README.md](./game-design/economy/)
- **Elevator** - Vertical transit, see [transit/elevators.md](./game-design/transit/elevators.md)
- **Entertainment Blocks** - Sports, leisure, see [blocks/entertainment.md](./game-design/blocks/entertainment.md)
- **Entropy** - Decay systems, see [dynamics/entropy.md](./game-design/dynamics/entropy.md)
- **Envelope** - Auto-generated exterior, see [core-concepts.md](./game-design/core-concepts.md#emergent-envelope)
...
- **Human Simulation** - Agent system, see [human-simulation/README.md](./game-design/human-simulation/)
- **HVAC** - Air infrastructure, see [environment/air-system.md](./game-design/environment/air-system.md)
...
### J-K
- **Junction Blocks** - Corridor turns, see [transit/corridors.md](./game-design/transit/corridors.md#junctions)
...
- **Mega-Blocks** - Large structures, see [blocks/README.md](./game-design/blocks/#mega-blocks)
- **Milestones** - Build order, see [architecture/milestones/](./architecture/milestones/)

### N
- **Narrative** - Storytelling systems, see [ui/narrative.md](./ui/narrative.md)
- **Needs** - Human requirements, see [human-simulation/needs.md](./game-design/human-simulation/needs.md)
- **NIMBYism** - Resident opposition, see [dynamics/human-nature.md](./game-design/dynamics/human-nature.md#nimbyism)
- **Noise System** - Environment, see [environment/noise-system.md](./game-design/environment/noise-system.md)
...
- **Performance** - Optimization, see [architecture/performance.md](./architecture/performance.md)
- **Permits** - Build permissions, see [economy/permits.md](./game-design/economy/permits.md)
- **Pneuma-Tube** - Fast transit, see [transit/elevators.md](./game-design/transit/elevators.md#pneuma-tube)
- **Population** - Demographics, see [game-design/scenarios.md](./game-design/scenarios.md#population)
- **Private Block** - Destination only, see [core-concepts.md](./game-design/core-concepts.md)
- **Public Block** - Traversable, see [core-concepts.md](./game-design/core-concepts.md)
- **Purpose** - Human need, see [human-simulation/needs.md](./game-design/human-simulation/needs.md)

### Q-R
- **Quick Reference** - Fast lookups, see [quick-reference/](./quick-reference/)
- **Relationship** - Social connection, see [human-simulation/relationships.md](./game-design/human-simulation/relationships.md)
- **Rent** - Income calculation, see [economy/rent.md](./game-design/economy/rent.md)
- **Residential Blocks** - Housing, see [blocks/residential.md](./game-design/blocks/residential.md)
- **Resilience** - AEI component, see [dynamics/eudaimonia.md](./game-design/dynamics/eudaimonia.md)

### S
- **Safety** - Human need, see [human-simulation/needs.md](./game-design/human-simulation/needs.md)
...
- **Tribalism** - Group dynamics, see [dynamics/human-nature.md](./game-design/dynamics/human-nature.md#tribalism)
...
- [milestone-1-grid-blocks.md](./architecture/milestones/milestone-1-grid-blocks.md)
- [milestone-2-floor-navigation.md](./architecture/milestones/milestone-2-floor-navigation.md)
- [milestone-3-connectivity.md](./architecture/milestones/milestone-3-connectivity.md)
- [milestone-4-light.md](./architecture/milestones/milestone-4-light.md)
- [milestone-5-economy.md](./architecture/milestones/milestone-5-economy.md)
- [milestone-6-time-simulation.md](./architecture/milestones/milestone-6-time-simulation.md)
- [milestone-7-residents.md](./architecture/milestones/milestone-7-residents.md)
- [milestone-8-pathfinding.md](./architecture/milestones/milestone-8-pathfinding.md)
- [milestone-9-block-types.md](./architecture/milestones/milestone-9-block-types.md)
- [milestone-10-overlays.md](./architecture/milestones/milestone-10-overlays.md)

### Block Catalogs
- [blocks/residential.md](./game-design/blocks/residential.md)
- [blocks/commercial.md](./game-design/blocks/commercial.md)
- [blocks/industrial.md](./game-design/blocks/industrial.md)
- [blocks/civic.md](./game-design/blocks/civic.md)
- [blocks/entertainment.md](./game-design/blocks/entertainment.md)
- [blocks/transit.md](./game-design/blocks/transit.md)
- [blocks/infrastructure.md](./game-design/blocks/infrastructure.md)
- [blocks/green.md](./game-design/blocks/green.md)

### System Docs
- [environment/light-system.md](./game-design/environment/light-system.md)
- [environment/air-system.md](./game-design/environment/air-system.md)
- [environment/noise-system.md](./game-design/environment/noise-system.md)
- [environment/safety-system.md](./game-design/environment/safety-system.md)
- [environment/vibes-system.md](./game-design/environment/vibes-system.md)

---

## Quick Search Tips

1. **Looking for a formula?** → [formulas.md](./quick-reference/formulas.md)
2. **Looking for a term?** → [glossary.md](./quick-reference/glossary.md)
